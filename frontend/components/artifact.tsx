    ...
    <AnimatePresence>
      {artifact.isVisible && (
        ...
        >
          ...
          {!isMobile && (
            ...
            >
              <AnimatePresence>
                {!isCurrentVersion && (
                  <motion.div
                    className="left-0 absolute h-dvh w-[400px] top-0 bg-foreground/30 z-50"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                  />
          ...
          <motion.div
            className="fixed dark:bg-muted bg-background h-dvh flex flex-col overflow-y-scroll md:border-l border-border"
            initial={
              isMobile
                ? {
                    opacity: 1,
